              ...
              <Tab
                ...
                title={
                  ...
                  >
                    ...
                    {tabKey === 'step4' && 'Restaurant Type & Availability'}
                    {tabKey === 'step5' && 'Restaurant Documentation'}
                  </span>
                }
              >
                <div className="tab-content-wrapper mt-4">
                  ...
                  <div className="skip-btn">
                    <Button onClick={() => setKey(getNextTab())} className={`btn-skip-btn ${tabKey === 'step4' ? 'last-tab-skip-btn' : ''}`} >
                      Skip for now
                    </Button>
                  </div>
