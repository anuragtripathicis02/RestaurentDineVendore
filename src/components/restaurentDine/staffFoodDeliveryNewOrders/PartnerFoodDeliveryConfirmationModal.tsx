...
const PartnerFoodDeliveryConfirmationModal = ({ show, handleClose }: any) => {
    ...
    return (
        <>
            <Modal show={show && !showDetailsModal} onHide={handleCloseAll} centered className="host-profile-modal common-modal-sec modal-small-box pt-4">
                <Modal.Body className="common-modal-body p-0 text-center pt-2">
                    ...
                    <div className='text-box'>
                        <h5 className='font-text mb-2'>Order (#2548) has been confirmed.</h5>
                        <p>Your order ( #12345) has been successfully placed. You will receive a confirmation shortly.</p>
                        <ul className='d-flex align-items-center gap-2 justify-content-between mt-4 ps-4 pe-4'>
                            <li>Order Preparation time</li>
                            <li>30-45 minutes</li>
                        </ul>
                    </div>
                </div>
...
export default PartnerFoodDeliveryConfirmationModal