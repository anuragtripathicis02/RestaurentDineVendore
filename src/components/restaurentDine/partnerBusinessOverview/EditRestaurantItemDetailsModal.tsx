...
// import SuccessIcon from "../../../../public/images/success-check.png"; 

const EditRestaurantItemDetailsModal = ({ show, handleClose }: any) => {
        ...
        <Modal.Body className="common-modal-body p-0">
          <div className='modal-box-from'>
            <div className='heading p-3 pt-5 pb-0 d-flex flex-md-nowrap flex-wrap align-items-center justify-content-between gap-2'>
              <h2 className='border-0 m-0 p-0'>Add & Edit Item Details</h2>
            ...
            <div className='form-modal-box card-box profile-availability bg-transparent shadow-none ps-0 pt-0 pe-0'>
              <div className="profile-owner p-16 pt-0 pb-0">
                <div className='row'>
                  <div className='col-md-12 mb-24'><GalleryUpdateBox /></div>
                  <div className='col-md-12 mb-24'><ItemDetails /></div>
                  <div className='col-md-12 mb-24'><ItemsPricing /></div>
                  <div className='col-md-12 mb-24'><Itemsavailable /></div>
                  <div className='col-md-12 mb-24'><ItemPreferences /></div>
                  <div className='col-md-12 mb-24'><CustomizeAddOn /></div>
                  <div className='col-md-12 mb-24'><Schedule /></div>
                  <div className='col-md-12 mb-24'><AddRecommendedItems /></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <Modal show={showSuccess} centered backdrop="static" keyboard={false} className="host-profile-modal modal-small-box sucess-modal-small pt-4">
        <Modal.Body className="common-modal-body p-0 text-center">
          <div className="modal-box-from p-5">
            ...
            <p>Your item has been added and will go live within 24 hours</p>
            <p className="text-muted small">We have sent a confirmation to your email & phone for reference.</p>
          </div>
        </Modal.Body>
      </Modal>
    </>
...
export default EditRestaurantItemDetailsModal;
